...
do 
    ...
    MW=$(grep "MW:" ${ITIC_file_name} | awk '{ print $2}')
       ...
       # Run excl 
    bash $HOME/Git/ITIC_GROMACS/Scripts/RerunITIC_GROMACS_Parallel.sh $molec 50 32 #bash $HOME/Git/ITIC_GROMACS/Scripts/RunExcl_GROMACS_Parallel.sh $molec 50 32 500000
